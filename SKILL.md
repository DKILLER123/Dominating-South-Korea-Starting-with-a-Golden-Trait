...
**Current at ship:** cycle 13 shipped (2026-09-16). Tree = 40 chapters · 102 payload entries ·
99 manifest items · 46 spine entries · 45 NCX navPoints · 48 nav list items · 29 images
...
no new images in cycle 13) · 20 WOFF faces · 20 character cards (4 bio appends in cycle 13:
Bae Do-yoon, Irene, Taeyeon, Jessica) · 20 introduction cards · 60 glossary cards (+ Taeseo CP,
internal digestion, ne). Package: 102 entries · 5,539,035 B · sha256 `3abc7113…`;
delivered-archive snapshots in `extracted/` (v1) and `extracted-v10/` (91 entries). Next image
id: **id-30**. Next chapter: **ch041** (NCX `num_46`, playOrder `46`, nav li 49). Reserved portraits: `uploads/Ha-Jiwon.png` (bottom-right watermark
