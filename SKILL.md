...
**Current at ship:** cycle 12 shipped (2026-09-15). Tree = 38 chapters · 100 payload entries ·
97 manifest items · 44 spine entries · 43 NCX navPoints · 46 nav list items · 29 images
(`cover-bg.jpg` repaired in place · cards `id-02`…`id-06` (`id-03` reader-provided Jessica),
`id-10`, `id-14`, `id-17`, `id-19`, `id-20`, `id-21`, `id-23` (reader-provided Irene),
`id-28` Mina, `id-29` Taeyeon (web-sourced press photographs, 736×920) · plates `wd_*` incl.
`id-25 wd_jiyeon_loungewear`, `id-26 wd_leeboojin_tea`, `id-27 wd_jessica_suite` — id ceiling 29)
· 20 WOFF faces · 20 character cards (+ Lee Yoon-hyang, + Mina, + Taeyeon) · 20 introduction
cards · 57 glossary cards (+ peninsula’s first heartthrob). Package: 100 entries · 5,522,418 B ·
sha256 `e33b5cd8…`; delivered-archive snapshots in `extracted/` (v1) and `extracted-v10/` (91
entries). Next image id: **id-30**. Next chapter: **ch039** (NCX `num_44`, playOrder `44`,
nav li 47). Reserved portraits: `uploads/Ha-Jiwon.png` (bottom-right watermark
